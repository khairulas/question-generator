...
# 5. HELPER FUNCTIONS
# ==============================================================================
# ... (All helper functions like extract_text_from_pdf, generate_questions, etc. remain the same)
...
# ... (All routes up to Quiz Management remain the same) ...
@app.route('/')
@login_required
def index():
...
# ... (rest of the routes like submit_quiz, view_attempts, etc. remain the same) ...
